      ...
      <div className="question-container">
        <div className="question">
          <label htmlFor="question1">
            What tasks or activities do you find most fulfilling and energizing
            in your current or previous experiences?
          </label>
        ...
        <div className="question">
          <label htmlFor="question3">
            What are your strongest skills or talents, whether developed through
        ...
        <div className="question">
          <label htmlFor="question4">
            Describe a work environment where you thrive: is it structured and
        ...
        <div className="question">
          <label htmlFor="question5">
            What type of problems do you enjoy solving or find most engaging?
          </label>
          <textarea id="question5" name="question5"></textarea>
        </div>
        <div className="question">
          <label htmlFor="question6">
            How important are factors like salary, job security, work-life
